        ...
        for i_e2 in range(ne2):
            ...
            for i_k1 in range(k1):
                ...
                for i_k2 in range(k2):
                    ...
                    x        = (2.0*x1-1.)*sqrt(1.0-0.5*(2.0*x2-1.0)**2)
                    y        = (2.0*x2-1.)*sqrt(1.0-0.5*(2.0*x1-1.0)**2)
                    ...
                    '''
                    # In the polar coordonate x = rcos(teta), y = rsin(teta)
                    x = x1*cos(2*pi*x2)
                    y = x1*sin(2*pi*x2)
                    F1x      = cos(2*pi*x2)
                    F1y      = -2*pi*x1*sin(2*pi*x2)
                    F2y      = 2**pi*x1*cos(2*pi*x2)
                    F2x      = sin(2*pi*x2)
                   '''
