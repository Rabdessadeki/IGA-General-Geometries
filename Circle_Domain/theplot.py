...
#here to apply homogenous boundary conditions

gx0_h         = L2_projection(knots2, p2,  gx0)
gx1_h         = L2_projection(knots2, p2, gx1)
gy0_h         = L2_projection(knots1, p1, gy0)
gy1_h         = L2_projection(knots1, p1, gy1)
